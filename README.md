...
docker cp foo.txt dev_baseline:/foo.txt

docker cp dev_baseline:/foo.txt foo.txt
...
원래환경에서 bash를 하나 실행한 후 sudo docker rmi dev_baseline를 입력하고 나서
